  ...
  return (
    <section className="text-center my-32 mx-4 sm:mx-8 md:mx-16 lg:mx-24">
      <div className="flex items-center justify-center mb-6">
        ...
        <h1 className="font-sans font-[500] text-3xl  sm:text-5xl md:text-6xl lg:text-7xl dark:text-white">
          PostureSmart
        </h1>
      </div>
      <p className="font-[600] text-2xl  dark:text-white mb-12">Correct your posture with Ai</p>
